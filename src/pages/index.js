...
export default function Home({ getposts }) {
        ...
        <div
          ...
          className={
            groupstyle === info.group
              ? styles.ChooseGroupBackClick
              : styles.ChooseGroupBack
          }
          ref={(elem) => (backRef[idx] = elem)}
        ></div>
        <div
          id={info.group}
          className={
            groupstyle === info.group
              ? styles.ChooseGroupContentClick
              : styles.ChooseGroupContent
          }
          ref={(elem) => (contentRef[idx] = elem)}
          onClick={clickGroup}
        >
          {info.group}
        </div>
  ...
  return (
    <div>
      ...
      <div className={styles.ChooseGroupParents}>{ShowGroup}</div>

      <div className={styles.SearchBox}>
        <div className={styles.SearchPosition}>
          <Image src={SearchIcon} alt="SearchIcon" />
          <input
            className={styles.SearchTitleInput}
        ...
        <select
          required
          className={styles.ChoosePosition}
        ...
        <select
          required
          className={styles.ChooseHowwork}
          onChange={changeHowwork}
        >
          <option disabled selected hidden>
            채용 형태
          </option>
